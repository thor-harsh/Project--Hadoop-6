 ...
 **In this project we use Apache Spark and we make an  amazing Movie Recommendation using this ADLS of Apache Spark which is an amazing tool for machine learning and lot of data mining tasks and other complicated deep learning uses and is built on top of hadoop**.<br></br>
